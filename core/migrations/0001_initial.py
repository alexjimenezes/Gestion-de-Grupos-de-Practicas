# Generated by Django 2.1.5 on 2020-11-19 14:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='par1', to=settings.AUTH_USER_MODEL)),
                ('student2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='par2', to=settings.AUTH_USER_MODEL)),
                ('studentBreakRequest', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='breakPair', to=settings.AUTH_USER_MODEL)),
            ],
            options={
