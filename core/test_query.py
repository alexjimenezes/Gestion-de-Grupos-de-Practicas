...
class QueryTest(TestCase):
    def setUp(self):
        ...
        self.thG.save()
        self.s = Student.objects.create(id=1000, first_name="student", last_name=str(1000), username=("student" + str(1000)), theoryGroup=self.thG)
        self.s.save()
        self.s1 = Student.objects.create(id=1001, first_name="student", last_name=str(1001), username=("student" + str(1001)), theoryGroup=self.thG)
        self.s1.save()
    ...
    def test_pair_1000_1001(self):
        ...
        t = Pair.objects.create(id=123, student1=student1, student2=student2, validated=False)
        t.save()
        print("\nPair created!\n")
    ...
    def test_other_constraints(self):
        ...
        oc_plus1day = OtherConstraints.objects.create(selectGroupStartDate=date1)
        oc_plus1day.save()
