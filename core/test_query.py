...
class QueryTest(TestCase):
    def setUp(self):
        ...
        self.thG.save()
        self.s = Student.objects.create(id=1000, first_name="student", last_name=str(
            1000), username=("student" + str(1000)), theoryGroup=self.thG)
        self.s.save()
        self.s1 = Student.objects.create(id=1001, first_name="student", last_name=str(
            1001), username=("student" + str(1001)), theoryGroup=self.thG)
        self.s1.save()

    def test_exist_create_st(self):
        print("\nTest01")
        try:
            self.s = Student.objects.create(id=1000, first_name="student", 
                                            last_name=str(1000), username=(
                                                "student" + str(1000)),
        ...
        try:
            self.s1 = Student.objects.create(id=1001, first_name="student",
                                             last_name=str(1001), username=(
                                                 "student" + str(1001)),
                                             theoryGroup=self.thG)
            self.s1.save()
        except:
    ...
    def test_pair_1000_1001(self):
        ...
        t = Pair.objects.create(id=123, student1=student1,
